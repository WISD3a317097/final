                ...
                success: function (data) {
                    ...
                    if(data.success==1){
                        ...
                        for(var i=0;i<d.length;i++){
                            html+="<div class='col-4 mt-5'><div class='card' style='width: 20rem;'><div class='card-body'><h4 class='card-title'>"+d[i].shop_name+"</h4><p lass='card-text'></p><a class='btn btn-primary text-light' onclick='link_click("+d[i].id+")'>打開</a></div></div></div>"
                        }
                    }
                    shop.innerHTML+=html;
